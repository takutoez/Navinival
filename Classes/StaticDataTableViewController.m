...
- (void)reloadDataAnimated:(BOOL)animated {
    ...
    if (!animated) {
        ...
        [self.tableView insertRowsAtIndexPaths:self.originalTable.insertIndexPaths withRowAnimation:UITableViewRowAnimationFade];
        
        [self.tableView deleteRowsAtIndexPaths:self.originalTable.deleteIndexPaths withRowAnimation:UITableViewRowAnimationFade];
