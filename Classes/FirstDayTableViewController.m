...
@interface FirstDayTableViewController (){
...
@implementation FirstDayTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    EventTableViewCell *cell = (EventTableViewCell *)[tableView dequeueReusableCellWithIdentifier:@"FirstDayEventCell"];
    int i = 0;
...
- (IBAction)halfTimeButton:(id)sender {
    ...
    [self performSegueWithIdentifier:@"ToDetailEventSegue" sender:self];
}
